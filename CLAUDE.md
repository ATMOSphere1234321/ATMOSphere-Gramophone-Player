...
# CLAUDE.md - ATMOSphere Gramophone Player

Fork of Gramophone music player, customized for ATMOSphere firmware on Orange Pi 5 Max (RK3588). Material Design 3 music player with Media3/ExoPlayer backend and hi-fi audio support.

## Project Overview

- **Package**: `atmosphere.gramophone.player`
- **Language**: Kotlin
- **Build**: Gradle KTS (AGP 9.0.1, Kotlin 2.3.0)
- **Repo**: `git@github.com:ATMOSphere1234321/ATMOSphere-Gramophone-Player.git`
- **Parent repo path**: `device/rockchip/atmosphere/gramophone-player`
- **Upstream**: AkaneTan/Gramophone
...
| `hificore/` | Hi-fi audio processing core |
| `baselineprofile/` | Startup and runtime performance profiles |

### ATMOSphere Integration

- Listed in `AUDIO_ONLY_PACKAGES` -- excluded from video routing to secondary display
- Uses Media3/ExoPlayer for audio playback (MediaSession published)
